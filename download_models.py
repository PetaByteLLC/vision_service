...
data_path = os.path.join(
    ".", "data", "models", "Detector", "yolov8", "yolov8s-2023-02-11.pt"
)
if not os.path.isfile(data_path):
    ROOT_DIR = os.path.dirname(os.path.abspath(__file__))
    data_path = load_file_from_url(
        url="https://cloud.sanarip.org/index.php/s/NYpfBa3BSot7APe/download/data.zip",
...
car_brand_url = [
    "https://cloud.sanarip.org/index.php/s/d5kmzHgz7fPLL2A/download/export_car_brand.pkl"
]
car_color_name = "export_car_color_detection.pkl"
car_color_url = [
    "https://cloud.sanarip.org/index.php/s/eNTc9Bcc29xQwrp/download/export_car_color_detection.pkl"
]
car_type_name = "export_car_body.pkl"
car_type_url = [
    "https://cloud.sanarip.org/index.php/s/yAmf3gzSRoFZgmx/download/export_car_body.pkl"
]
yolov8_name = "yolov8x.pt"
yolov8_url = [
    "https://cloud.sanarip.org/index.php/s/c8LByRzRc7MGWnB/download/yolov8x.pt"
]
truck_brand_name = "export_truck_brand.pkl"
truck_brand_url = [
    "https://cloud.sanarip.org/index.php/s/7tmD8GBH9SRqA4W/download/export_truck_brand.pkl"
]

# ls
country_model = "country_model_v7am.pkl"
file_url = [
    "https://cloud.sanarip.org/index.php/s/TbMfZgdDrbRLe7g/download/country_model_v7am.pk1"
]
model_name = "RealESRGAN_x4plus"
model_url = [
    "https://cloud.sanarip.org/index.php/s/2XfFdM4CJt52rmm/download/RealESRGAN_x4plus.pth"
]

...
class NumberPlateDetectionAndReadingV2(Pipeline):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.option_detector.load(
            path_to_classification_model, options=classification_options
        )

        if presets is None:
            presets = DEFAULT_PRESETS
        self.ocr_detector = ocr_class_detector(
            presets, default_label, default_lines_count
        )

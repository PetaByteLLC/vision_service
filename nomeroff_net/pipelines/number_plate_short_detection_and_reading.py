...
from nomeroff_net.tools.image_processing import (
    crop_number_plate_rect_zones_from_images,
    group_by_image_ids,
)
...
class NumberPlateShortDetectionAndReading(Pipeline, CompositePipeline):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.number_plate_localization = NumberPlateLocalization(
            "number_plate_localization", image_loader, path_to_model=path_to_model
        )
    ...
    def forward(self, inputs: Any, **forward_parameters: Dict) -> Any:
        ...
        zones, image_ids = crop_number_plate_rect_zones_from_images(
            images, images_bboxs
        )
        ...
        number_plate_text_reading_res = unzip(
            self.number_plate_text_reading(
                unzip([zones, region_names, lines]), **forward_parameters
            )
        )
        ...
        return unzip([images, images_bboxs, zones, texts])

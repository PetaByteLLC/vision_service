...
from .multiline_number_plate_detection_and_reading import (
    MultilineNumberPlateDetectionAndReading,
)
from nomeroff_net.pipelines.base import RuntimePipeline


class MultilineNumberPlateDetectionAndReadingRuntime(
    MultilineNumberPlateDetectionAndReading, RuntimePipeline
):
    """

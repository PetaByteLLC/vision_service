...
class InverseImgGenerator(ImgGenerator):
    def __init__(
        ...
        super(ImgGenerator, self).__init__(
            dirpath, img_w, img_h, batch_size, labels_counts, with_aug
        )
        ...
        for file_name in os.listdir(img_dirpath):
            ...
            if ext == ".png":
                ...
                if os.path.exists(json_filepath):
                    ...
                    self.samples.append(
                        [img_filepath, int(description.get("orientation", -1))]
                    )
    ...
    def __getitem__(self, index):
        ...
        x, y = copy.deepcopy(self.paths[self.indexes[index]]), copy.deepcopy(
            self.discs[self.indexes[index]]
        )

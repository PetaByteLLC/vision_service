...
def show_data(img_path, json_path, max_count_image=1):
    ...
    for i, p in enumerate(data["_via_img_metadata"]):
        ...
        variant_images, variants_bboxes = generate_image_rotation_variants(
            img, target_boxes, angles=[90, 180, 270]
        )
        angles = [0, 90, 180, 270]
        for variant_image, variant_bboxes, angle in zip(
            variant_images, variants_bboxes, angles
        ):

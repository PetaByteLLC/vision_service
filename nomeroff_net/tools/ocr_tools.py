...
def decode_prediction(logits: torch.Tensor, label_converter: StrLabelConverter) -> str:
...
def decode_batch(
    net_out_value: torch.Tensor, label_converter: StrLabelConverter
) -> str or List:
    texts = []
...
def print_prediction(
    model, dataset, device, label_converter, w=200, h=50, count_zones=16
):
    import matplotlib.pyplot as plt

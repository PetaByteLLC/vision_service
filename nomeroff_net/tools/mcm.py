...
model_config_urls = [
    ...
    "https://models.vsp.net.ua/config_model/nomeroff-net-ocr-eu/model-efficientnet_b2-2.json",
...
modelhub = ModelHub(model_config_urls=model_config_urls, local_storage=local_storage)
